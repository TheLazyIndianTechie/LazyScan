...
class FileScanner:
    ...
    def count_files(self, scan_path: str) -> int:
        ...
        try:
            ...
            logger.warning("Failed to count files in some directories", 
                          scan_path=scan_path, error=str(e))
    ...
    def count_files_with_progress(
        ...
        def count_task():
            ...
            try:
                ...
                logger.warning("Failed to count files", scan_path=scan_path, error=str(e))
...
def scan_directory_with_progress(scan_path: str, colors: tuple) -> List[Tuple[str, int]]:
    """Scan directory with progress display and return file sizes."""
    from ..core.formatting import truncate_path
    
    logger.info("Starting directory scan with progress", extra={
        "scan_path": scan_path,
        ...
        for root, dirs, files in os.walk(scan_path):
            ...
            for name in files:
                ...
                try:
                    ...
                    logger.debug("Unable to get file size", extra={
                        "file_path": full_path,
                        "error": str(e)
                    })
                    continue
