...
class LazyScanConfig:
    ...
    def mark_disclaimer_acknowledged(self, version: str) -> None:
        ...
        try:
            ...
            self.config.set('disclaimer', 'acknowledged_date', datetime.now().isoformat())
            ...
            logger.error("Failed to mark disclaimer as acknowledged", 
    ...
    def get_user_preference(self, section: str, key: str, default=None):
        ...
        try:
            ...
            logger.debug("Error getting user preference", 
    ...
    def set_user_preference(self, section: str, key: str, value: str) -> None:
        ...
        try:
            ...
            logger.error("Failed to set user preference", 
                        section=section, key=key, value=value, error=str(e))
            raise
