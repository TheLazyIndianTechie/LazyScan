...
class TestLazyScanError:
    ...
    def test_error_with_context(self):
        ...
        error = LazyScanError("Test error", ExitCode.PATH_ERROR, context, "User message")
    ...
    def test_to_dict_conversion(self):
        ...
        context = {"test": "value"}
        error = LazyScanError("Test message", ExitCode.CONFIG_ERROR, context, "User message")
...
class TestSpecificExceptions:
    ...
    def test_deletion_safety_error(self):
        ...
        error = DeletionSafetyError("Unsafe deletion", path="/", reason="root directory")
    ...
    def test_discovery_error(self):
        ...
        error = DiscoveryError("No projects found", search_paths=search_paths, app_type="unity")
