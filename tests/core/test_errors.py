...
class TestErrorHandling:
    ...
    def test_handle_custom_exception(self):
        ...
        result = handle_exception(error, logger, "test_operation", re_raise=False)
    ...
    def test_format_user_error_generic(self):
        ...
        assert "❌ Unexpected error: Generic error" == result
...
class TestCLIErrorHandler:
    ...
    def test_lazyscan_error_handling(self):
        ...
        with patch("lazyscan.core.logging_config.get_console") as mock_get_console:
            with pytest.raises(SystemExit) as exc_info:
                failing_func()

            assert exc_info.value.code == ExitCode.PATH_ERROR
            mock_get_console().print_error.assert_called_once()
    ...
    def test_unexpected_exception_handling(self):
        ...
        with patch("lazyscan.core.logging_config.get_console") as mock_get_console:
            ...
            assert mock_get_console().print_error.call_count >= 1
...
class TestIntegration:
    ...
    def test_error_propagation_through_layers(self):
        ...
        with patch("lazyscan.core.logging_config.get_console") as mock_get_console:
            ...
            mock_get_console().print_error.assert_called()
            error_msg = mock_get_console().print_error.call_args[0][0]
