...
class TestSecurityPolicy:
    ...
    def test_policy_hash_generation(self):
        ...
        policy_data = {
            "behavior_flags": {"require_trash_first": True, "interactive_double_confirm": True, "block_symlinks": True},
            "size_limits": {"large_directory_threshold_mb": 100, "max_deletion_size_mb": 1000},
            "allowed_roots": {},
            "deny_patterns": {}
        }
...
class TestSecuritySentinel:
    ...
    def test_guard_delete_permanent_mode_blocked(self, valid_policy):
        ...
        with tempfile.NamedTemporaryFile(delete=False) as tmp:
            ...
            try:
                with pytest.raises(SecurityPolicyError, match="Permanent deletion blocked"):
